...
TEST(Component, VoidType) {
    using traits_type = entt::component_traits<void, entt::entity>;
...
TEST(Component, Empty) {
    using traits_type = entt::component_traits<test::empty, entt::entity>;
...
TEST(Component, NonEmpty) {
    using traits_type = entt::component_traits<test::boxed_int, entt::entity>;
...
TEST(Component, NonMovable) {
    using traits_type = entt::component_traits<test::non_movable, entt::entity>;
...
TEST(Component, SelfContained) {
    using traits_type = entt::component_traits<self_contained, entt::entity>;
...
TEST(Component, TraitsBased) {
    using traits_type = entt::component_traits<traits_based, entt::entity>;
